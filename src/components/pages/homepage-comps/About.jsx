    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">I'm Mounika Mandangi, a Full Stack Developer based in India with a strong background in web technologies and a natural passion for building things that live on the internet.</p>
                    <p>What excites me the most is how limitless the world of web development is. I'm constantly learning new technologies and expanding my skill set to craft better, faster, and smarter applications. My curiosity and creative drive push me to turn ideas into functional digital experiences, and I look forward to collaborating with teams and individuals who share the same passion</p>

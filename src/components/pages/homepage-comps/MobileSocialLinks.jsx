    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/mounikamandangi/',
            style: 'rounded-tr-md'
        },
        {
            id: 2,
            ...
            href: 'https://github.com/mounika-2131'
        },
        {
            id: 3,
            child: (
            ...
            href: 'mailto:mounikamandangi99@gmail.com'
        },
        {
            id: 4,
            child: (
            ...
            href: '/resume.pdf', // Use the uploaded resume in public
            style: 'rounded-br-md'
        }
    ]
